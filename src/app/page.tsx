                    ...
                    >
                        ...
                        <div className="mt-4 rounded-lg border border-gray-200 dark:border-gray-800">
                            ...
                            {visitSchedules.length === 0 ? (
                                <p className="px-3 py-4 text-sm text-gray-600 dark:text-gray-300">
                                    아직 저장된 일정이 없어요. 아래 병원 일정 추가 버튼으로 첫 일정을 등록해 주세요.
                                </p>
                            ) : (
                            ...
                            {visitFormMessage && (
                                <p
                                    className={`mt-2 text-sm font-semibold ${
                                        visitFormIsError ? 'text-rose-600 dark:text-rose-300' : 'text-emerald-600 dark:text-emerald-300'
                                    }`}
                                >
                                    {visitFormMessage}
                                </p>
                        ...
                        {showVisitScheduleForm && (
                            <div className="mt-3 rounded-lg border border-gray-200 bg-gray-50 p-3 dark:border-gray-800 dark:bg-gray-950/40">
                                <form onSubmit={handleVisitScheduleSave} className="grid gap-3 sm:grid-cols-2">
